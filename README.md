...
دو سال پیش که دیدم منبع فارسی درست‌حسابی برای یادگیری دیزاین پترن‌ها کمه، یه **ریپازیتوری** ساختم به اسم [دیزاین پترن به زبان آدمیزاد](https://github.com/EPSOFT/LLM).  استقبال خوبی هم ازش شد.
...
*   **🤖 مدل‌های زبانی بزرگ (LLM)** [🔗](#user-content-مدلهای-زبانی-بزرگ-llm-چی-هستن-اصلاً-)
*   **✍️ پرامپت‌نویسی** [🔗](#user-content-پرامپتنویسی-یعنی-چی-چطور-به-llm-دستور-بدیم-️)
    *   چطور یه پرامپت خوب بنویسیم؟ [🔗](#user-content-خب-چطور-یه-پرامپت-خوب-و-کارراهانداز-بنویسیم-)
    *   نمونه‌ای از یک پرامپت خوب [🔗](#user-content-یه-مثال-ساده-از-پرامپتنویسی-)
*   **🚀 چطور یه پرامپت قوی‌تر بنویسیم؟** [🔗](#user-content-چطور-پرامپتهای-بهتری-بنویسیم-تکنیکهای-پیشرفتهتر-)
    *   ۱. استفاده از مرزها [🔗](#user-content-۱-دستور-و-داده-رو-قاطی-نکن-استفاده-از-جداکنندهها-️)
    *   ۲. خروجی ساختاریافته [🔗](#user-content-۲-خروجی-رو-تو-قالب-دلخواهت-بگیر-json-لیست-جدول-و-️)
    *   ۳. تغییر لحن خروجی [🔗](#user-content-۳-به-مدل-بگو-با-چه-لحنی-حرف-بزنه-رسمی-خودمونی-طنزآمیز-)
    *   ۴. بررسی شرایط [🔗](#user-content-۴-شرط-بذار-بعد-دستور-بده-)
    *   ۵. مثال‌های موفق [🔗](#user-content-۵-با-مثال-بهش-یاد-بده-چی-میخوای-few-shot-prompting-)
    *   ۶. حل مسئله قبل از جواب [🔗](#user-content-۶-ازش-بخواه-قدم-به-قدم-فکر-کنه-و-بعد-جواب-بده-)
    *   ۷. تکرار و بهبود [🔗](#user-content-۷-بار-اول-نشد-دوباره-و-دوباره-امتحان-کن-تکرار-و-بهبود-)
    *   جمع‌بندی نهایی [🔗](#user-content-جمعبندی-جعبه-ابزار-پرامپتنویسی-حرفهای-)
